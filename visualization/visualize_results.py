...
@hydra.main(config_path="../config", config_name="test_magicpony_horse")
def main(cfg):
    ...
    for i in tqdm(range(0, total_num, batch_size)):
        ...
        with torch.no_grad():
            ...
            if hasattr(model.netInstance, "enable_motion_vae"):  # Disable generation for ponymation reconstruction
                model.netInstance.enable_motion_vae = False
            model.set_eval()
            ...
            prior_shape, dino_pred = model.netBase(is_training=False)
